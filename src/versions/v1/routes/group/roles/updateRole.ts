...
export default {
    ...
    handler: async (req, res) => {
        try {
            ...
            const role = await prisma.groupRoles.update({
                where: {
                    UUID,
                    groupId
                },
